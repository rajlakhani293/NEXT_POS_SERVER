...
@permissionRequired("nexopos.create.customers")
...
@permissionRequired("nexopos.read.customers")
...
@permissionRequired("nexopos.read.customers-groups")
...
@permissionRequired("nexopos.create.customers-groups")
...
@permissionRequired("nexopos.delete.customers-groups")
...
@permissionRequired("nexopos.update.customers-groups")
...
@permissionRequired("nexopos.update.customers-groups", "nexopos.update.customers", match="all")
...
@permissionRequired("nexopos.read.customers-groups", "nexopos.read.customers", match="all")
...
@permissionRequired("nexopos.create.customers-groups")
def createNexoCustomerGroup(request, payload: CustomerGroupIn):
    return CustomerGroupService.create(payloadData(payload), request)


@groupsRouter.get("/{group_id}", response=ApiResponse)
@permissionRequired("nexopos.read.customers-groups")
def getNexoCustomerGroupById(request, group_id: int):
    return CustomerGroupService.getById(group_id, request)


@groupsRouter.get("/", response=ApiResponse)
@permissionRequired("nexopos.read.customers-groups")
def getNexoCustomerGroups(request):
    return CustomerGroupService.getAll({}, request)


@groupsRouter.get("/{group_id}/customers", response=ApiResponse)
@permissionRequired("nexopos.read.customers-groups", "nexopos.read.customers", match="all")
def getNexoCustomerGroupCustomers(request, group_id: int):
    return CustomerGroupService.getCustomers(group_id, request)


@groupsRouter.delete("/{group_id}", response=ApiResponse)
@permissionRequired("nexopos.delete.customers-groups")
def deleteNexoCustomerGroup(request, group_id: int):
    return CustomerGroupService.delete({"ids": [group_id]}, request)


@groupsRouter.post("/transfer-customers", response=ApiResponse)
@permissionRequired("nexopos.update.customers-groups", "nexopos.update.customers", match="all")
def transferNexoCustomerGroupCustomers(request, payload: CustomerGroupTransferIn):
    return CustomerGroupService.transferCustomers(payloadData(payload, by_alias=True), request)


@groupsRouter.put("/{group_id}", response=ApiResponse)
@permissionRequired("nexopos.update.customers-groups")
def updateNexoCustomerGroup(request, group_id: int, payload: CustomerGroupUpdateIn):
    return CustomerGroupService.update(payloadData(payload, exclude_none=True), request, group_id)


@router.delete("/delete", response=ApiResponse)
@permissionRequired("nexopos.delete.customers")
...
@permissionRequired("nexopos.update.customers")
...
@permissionRequired("nexopos.customers.manage-account-history")
...
@permissionRequired("nexopos.read.customers", "nexopos.read.customers-groups", match="all")
...
@permissionRequired("nexopos.read.customers", "nexopos.read.orders", match="all")
