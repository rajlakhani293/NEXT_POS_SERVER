    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('dematerialized', 'Dematerialized'), ('materialized', 'Materialized'), ('grouped', 'Grouped')], default='materialized', max_length=20)),
        ...
        migrations.AlterUniqueTogether(
            name='product',
            unique_together={('branch', 'barcode'), ('branch', 'sku')},
        ),
    ]
