...
class Order(TenantAwareModel):
    ...
    process_status = models.CharField(max_length=30, default="pending")
    ...
    subtotal = models.DecimalField(max_digits=14, decimal_places=5, default=0)
    total_with_tax = models.DecimalField(max_digits=14, decimal_places=5, default=0)
    total_coupons = models.DecimalField(max_digits=14, decimal_places=5, default=0)
    total_cogs = models.DecimalField(max_digits=14, decimal_places=5, default=0)
    total = models.DecimalField(max_digits=14, decimal_places=5, default=0)
    tax_amount = models.DecimalField(max_digits=14, decimal_places=5, default=0, db_column="tax_value")
    ...
    tendered_amount = models.DecimalField(max_digits=14, decimal_places=5, default=0, db_column="tendered")
    change_amount = models.DecimalField(max_digits=14, decimal_places=5, default=0, db_column="change")
...
class OrdersProduct(TenantAwareModel):
    ...
    mode = models.CharField(max_length=30, default="normal")
    product_type = models.CharField(max_length=30, default="product")
    ...
    discount_type = models.CharField(max_length=30, default="none")
    discount_amount = models.DecimalField(max_digits=18, decimal_places=5, default=0, db_column="discount")
    quantity = models.DecimalField(max_digits=18, decimal_places=5)
    discount_percentage = models.DecimalField(max_digits=18, decimal_places=5, default=0)
    unit_price = models.DecimalField(max_digits=18, decimal_places=5, default=0)
    ...
    total = models.DecimalField(max_digits=18, decimal_places=5, default=0, db_column="total_price")
    ...
    cost_price = models.DecimalField(max_digits=18, decimal_places=5, default=0, db_column="total_purchase_price")
...
class OrdersRefund(TenantAwareModel):
    ...
    tax_amount = models.DecimalField(max_digits=18, decimal_places=5, default=0, db_column="tax_value")
    shipping = models.DecimalField(max_digits=18, decimal_places=5)
